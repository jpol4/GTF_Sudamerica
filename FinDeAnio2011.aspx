<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GalleryMasterPage2.master" AutoEventWireup="true" CodeFile="FinDeAnio2011.aspx.cs" Inherits="FinDeAnio2011" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        ...
        currentPage = 1;
        cantImages = 111;
        relPathShow = 'Images/Fotos y videos/FinDeAnio2011/Fotos/';
...
<asp:Content ID="Content3" ContentPlaceHolderID="EventDescription" Runat="Server">
    <table style="margin-left: 0px">
            <tr>
                <td>
                    <a href="Images/Fotos y videos/FinDeAnio2011/poster_WEB.jpg" target="_blank">
                        <img alt="Poster" src="Images/Fotos y videos/FinDeAnio2011/poster_WEB_300.jpg" /></a><br />
                ...
                <td style="vertical-align: top">
                    <ul>
                        ...
                        <li><font style="color: #0278ff; text-decoration: underline; font-size: medium; font-weight: bold">
                            Fecha:</font> Sábado 10 de Diciembre de 2011</li>
                        <li><font style="color: #0278ff; text-decoration: underline; font-size: medium; font-weight: bold">
