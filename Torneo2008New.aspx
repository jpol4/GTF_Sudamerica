<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GalleryMasterPage2.master" AutoEventWireup="true" CodeFile="Torneo2008New.aspx.cs" Inherits="Torneo2008New" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        ...
        currentPage = 1;
        cantImages = 34;
        relPathShow = 'Images/Fotos y videos/Torneo2008/Fotos/';
...
<asp:Content ID="Content3" ContentPlaceHolderID="EventDescription" Runat="Server">
    <table style="margin-left: 0px">
            <tr>
                <td>
                    <a href="Images/Fotos y videos/Torneo2008/POSTER CAMPEONATO NACIONAL 2008.JPG" target="_blank">
                        <img alt="Poster" src="Images/Fotos y videos/Torneo2008/POSTER CAMPEONATO NACIONAL 2008_300.JPG" /></a><br />
...
<asp:Content ID="Content5" ContentPlaceHolderID="Videos" Runat="Server">
    <div class="wrapperCentered">
        <h3>
                TRAILER DEL CAMPEONATO NACIONAL 2008</h3>
            <embed src="http://blip.tv/play/haNZgdCicwI" type="application/x-shockwave-flash"
