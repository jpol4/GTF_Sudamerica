<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GalleryMasterPage2.master" AutoEventWireup="true" CodeFile="Brisas2010New.aspx.cs" Inherits="Brisas2010New" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        ...
        currentPage = 1;
        cantImages = 90;
        relPathShow = 'Images/Fotos y videos/Brisas2010/Fotos/';
...
<asp:Content ID="Content3" ContentPlaceHolderID="EventDescription" Runat="Server">
    <table style="margin-left: 0px">
            <tr>
                <td>
                    <a href="Images/Fotos y videos/Brisas2010/POSTER WEB.jpg" target="_blank">
                        <img alt="Poster" src="Images/Fotos y videos/Brisas2010/POSTER WEB_300.jpg" /></a><br />
                ...
                <td style="vertical-align: top">
                    <ul>
                        ...
                        <li><font style="color: #0278ff; text-decoration: underline; font-size: medium; font-weight: bold">
                            Fecha:</font> Sábado 20 de Noviembre de 2010</li>
                        <li><font style="color: #0278ff; text-decoration: underline; font-size: medium; font-weight: bold">
...
<asp:Content ID="Content5" ContentPlaceHolderID="Videos" Runat="Server">
    <div class="wrapperCentered">
         <h3>
                TEASER EXHIBICIÓN BRISAS 2010</h3>
            <embed src="http://blip.tv/play/haNZgfe0LgI" type="application/x-shockwave-flash"
                width="480" height="320" allowscriptaccess="always" allowfullscreen="true"></embed>
            <img alt="Barra ayuda" src="Images/debajovideos.jpg" />
    </div>
    <div class="wrapperCentered">
        <h3>
                TRAILER EXHIBICIÓN BRISAS 2010</h3>
            <embed src="http://blip.tv/play/haNZgqf5AAI" type="application/x-shockwave-flash"
                width="480" height="320" allowscriptaccess="always" allowfullscreen="true"></embed>
                <img alt="Barra ayuda" src="Images/debajovideos.jpg" />
    </div>
</asp:Content>
